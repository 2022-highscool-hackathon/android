...
import com.example.presentation.databinding.FragmentDolbomiDolbomiMapBinding
...
class DolbomiDolbomiMapFragment: Fragment(), OnMapReadyCallback {
    lateinit var googleMap: GoogleMap
    private lateinit var binding: FragmentDolbomiDolbomiMapBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_dolbomi_dolbomi_map, container, false)
        binding.mapview.apply {
            onCreate(savedInstanceState)
            getMapAsync(this@DolbomiDolbomiMapFragment)
        }
    ...
    override fun onMapReady(p0: GoogleMap) {
        ...
        marker.apply {
            val bitmapDrawable = resources.getDrawable(R.drawable.ic_pin_me_girl) as BitmapDrawable
        ...
        for (i in 0 until 5) {
            googleMap.addMarker(MarkerOptions().apply {
                val a = if(i % 2 == 0) R.drawable.ic_pin_grandfather else R.drawable.ic_pin_grandmother
